...
import (
	...
	scheme "github.com/joshrendek/k8s-external-postgres/pkg/client/clientset/versioned/scheme"
...
func newPostgreses(c *DatabasesV1Client, namespace string) *postgreses {
	return &postgreses{
		client: c.RESTClient(),
		ns:     namespace,
	}
